...
namespace CartoonFX
{
    ...
    {
        [Header("Dynamic")] [Tooltip("Allow changing the text at runtime with the 'UpdateText' method. If disabled, this script will be excluded from the build.")]
        ...
        [Header("Colors")] [SerializeField] private Color backgroundColor = new Color(0, 0, 0, 1);
